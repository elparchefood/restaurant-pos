alter table tenants add column if not exists web_combos_orden integer default 0;
comment on column tenants.web_combos_orden is
  'Puesto de la categoria virtual Combos en la carta del cliente. 0 = primera, porque las categorias de verdad arrancan en 1. Se mueve igual que sort_order de pos_categories.';
