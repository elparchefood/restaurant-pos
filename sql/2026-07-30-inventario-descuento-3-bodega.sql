-- ═══════════════════════════════════════════════════════════════
-- Parte 3 (corrección): sub-inventario con "vender de bodega".
-- Antes: si el insumo tenía sub_inventario, TODO salía de stock_servicio
--        → la nevera se iba a negativo y la bodega nunca bajaba.
-- Ahora: se toma lo que haya EN SERVICIO y el faltante sale de BODEGA
--        (solo si vender_bodega está activo — es lo que el usuario acepta
--        en el aviso). Se registran hasta DOS movimientos por insumo
--        (uno 'servicio' y otro 'stock'), así la devolución es exacta.
-- ═══════════════════════════════════════════════════════════════
